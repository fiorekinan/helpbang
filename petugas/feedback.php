...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard-petugas.php">
                <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas fa-solid fa-hand-point-up"></i>
                </div>
                <div class="sidebar-brand-text mx-3">HelpBang!</div>
            </a>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-danger">Kasih Feedback untuk laporan dengan ID <?= $report_id ?></h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <form method="POST">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="feedback" placeholder="Masukan feedback kamu" rows="3" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-warning">Kirim Feedback</button>
                                    </form>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; HelpBang! 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-warning" href="../auth/logout.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
