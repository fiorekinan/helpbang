...
<head>
    ...
    <link rel="shortcut icon" href="../assets/hand-point-up-solid.svg" type="image/x-icon">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <dotlottie-player src="https://lottie.host/418ced15-aab4-4a55-9ad3-1d69873327aa/dTJRoH3FL1.lottie" background="transparent" speed="1" style="width: 500px; height: 500px;" loop autoplay></dotlottie-player>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h3 class="h6 text-gray-900">HelpBang! ada di sini untuk jadi tempat keluh kesah kamu</h3>
                                    </div>
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <button type="submit" name="login" class="btn btn-warning btn-user btn-block">Login</button>
                                    </form>
